...
class TestRightIntersection(unittest.TestCase):
    ...
    def test_intersection_no_iterable(self):
        array1 = 1
        array2 = 1
        self.assertRaises(TypeError, intersection.right_intersection, array1, array2)
...
class TestRightIntersection(unittest.TestCase):
    def test_no_intersections(self):
        ...
        self.assertEqual(list(intersection.left_intersection(array1, array2)), [])

    def test_intersection_extreme_elements(self):
        array1 = [1, 9]
        array2 = [1, 3, 3, 3, 3, 9]
        self.assertEqual(list(intersection.left_intersection(array1, array2)), [1, 9])

    def test_intersection_full(self):
        array1 = [3, 3, 3, 3, 7, 7, 9, 9, 12, 12]
        array2 = [3, 3, 3, 3, 7, 7, 9, 9, 12, 12]
        self.assertEqual(list(intersection.left_intersection(array1, array2)), array1)

    def test_intersection_partial(self):
        array1 = [1, 3, 3, 3, 3, 9]
        array2 = [1, 10]
        self.assertEqual(list(intersection.left_intersection(array1, array2)), [1])
